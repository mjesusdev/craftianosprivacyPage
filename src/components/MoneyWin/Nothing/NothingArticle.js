...
export const NothingArticle = () => {
    return (
        <>
            {/* <div classNameName="col col-md-3"></div> */}
            <div classNameName="col-12 col-md-7 mt-2 article">
                    ...
                    <div className="row no-gutters">
                        <div className="col-md-4">
                            <a href="../honeygain/">
                                <img 
                                    ...
                                    src="../images/otros/dinero-sin-hacer-nada.png" 
                        ...
                        <div className="col-md-7">
                            <div className="card-body">
                                ...
                                <a className="btn btn-outline-info" href="../honeygain/">
                    ...
                    <div className="row no-gutters">
                        ...
                        <div className="col-md-7">
                            <div className="card-body">
                                ...
                                <a className="btn btn-outline-info" href="../iproyal-panws/">
                                    Pulsa aquí para ver más 👏
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="row no-gutters">
                        <div className="col-md-4">
                            <a href="../smartme-app/">
                                <img 
                                    className="img-fluid card-img" 
                                    src="../images/smartme-app/smartmeapp.png" 
                                    alt="Imagen SmartmeApp"
                                />
                            </a>
                        </div>
                        <div className="col-md-7">
