...
export const LetyShopsArticle = () => {
    return (
        <>
            <div className="col col-md-3"></div>
            <div className="col-12 col-md-6 mt-2 article">
                <h1 className="h3 text-primary mb-4">LetyShops 🎁 - Recibe dinero haciendo compras online</h1>
                <h2 className="h4 text-primary mb-4">Más de 3.800 tiendas en las que recibir cashback 🤩</h2>
