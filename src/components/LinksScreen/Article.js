...
export const Article = () => {
    return (
        <>
            { /* col-md-9 col-lg-5 col-xl-6 col-xxl-7 */ }
            <div className="col col-md-9 col-lg-5 col-xl-6 col-xxl-7 article">
                <div className="card">
                        ...
                        <p>
                            <ul className="enlaces">
                                <li className="fw-bold">
                                    I-Say: <a href="../i-say/"> La mejor plataforma, se gana mucho 🤑🤑 </a>
                                </li>
                                <li className="fw-bold">
                                    YouGov: <a href="../yougov/">Segunda mejor plataforma ⚡</a>
                                </li>
                                <li className="fw-bold">
                                    PrizeRebel: <a href="../prize-rebel/">Cuenta con un mágnifico
                                        sistema de referidos y programa de fidelidad 👏</a>
                                </li>
                                <li className="fw-bold">
                                    MarketAgent: 
                                    <a href="../marketagent/">
                            ...
                            <ul className="enlaces">
                                ...
                                <li className="fw-bold">
                                    ...
                                    <a href="https://bit.ly/fullTipCR" target="_blank" rel="noopener noreferrer">
                                        Diferente a las demás, porque tiene la opción de recomendar y ganar por ello.
                                    </a>
                                    <br />
                                    Ganas 10€ al hacer tu primera compra de más de 15€ 😊
                                    <br />
                                    (RECUERDA: Utilizar el código: JESÚ-C39 para los 10€ ⚡)
                                </li>
                                <li className="fw-bold">
                                    Promos App:
                                    <a href="../promos-app/">
                            ...
                            <ul className="enlaces">
                                ...
                                <li className="fw-bold">
                                    ...
                                    <a href="../vivid-money/" target="_blank">
                                        Únete y obtén 3 meses de PREMIUM (cashback) y 10€ GRATIS
                                    </a>
                                </li>
                                <li className="fw-bold">
                                ...
                                <li className="fw-bold">
                                    ...
                                    <a href="../verse-app/">
                                        Empieza a utilizar Verse y haz pagos con amigos en segundos, además
                                        de poder ganar 5€ al UNIRTE y mucho más, ¿te lo vas a perder? 👋💙
                                    </a>
                                </li>
                                <li className="fw-bold">
            ...
            <div className="col col-md-3 offset-md-0 ">
                <div className="card">
                    <div className="card-body">
                ...
                <div className="bannerVerse col-10 ms-5">
                    <a href="https://bit.ly/VerseCR" target="_blank" rel="noreferrer">
                        <img className="img-fluid rounded mx-auto d-block w-75 mt-4" src="../images/verse/banner.png" 
